...
public:
	...
	NBV_Planner(shared_ptr<Share_Data>& _share_data, vector<View>& _init_views, int _first_init_view_id) {
		...
		root_nbvs["scale"] = 1;
		root_nbvs["offset"][0] = 0.5 + share_data->object_center_world(0) / share_data->view_space_radius;
		...
		root_render["scale"] = 1;
		root_render["offset"][0] = 0.5 + share_data->object_center_world(0) / share_data->view_space_radius;
